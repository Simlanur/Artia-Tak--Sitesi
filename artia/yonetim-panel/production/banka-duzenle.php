...
<div class="right_col" role="main">  <!-- Sayfanın ana içeriğini başlatıyoruz -->
  ...
  <div class="page-title">  <!-- Sayfa başlık kısmı -->
    <div class="title_left">  <!-- Başlık kısmının sol kısmı -->
      <h3>banka Güncelleme İşlemleri <small>  <!-- Sayfanın başlığı -->
      ...
      <div class="x_content">  <!-- Panel içeriği başlıyor -->
        <form action="../islemler.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">  <!-- Form başlatıyoruz ve işlemler.php dosyasına veri göndereceğiz -->
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">banka Ad <span class="required">*</span>  <!-- Banka adı etiketi -->
            </label>
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">banka Sıra <span class="required">*</span>  <!-- Banka IBAN etiketi -->
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">  <!-- Form alanının genişliğini ayarlıyoruz -->
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">banka Sıra <span class="required">*</span>  <!-- Banka hesap sahibi adı etiketi -->
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">  <!-- Form alanının genişliğini ayarlıyoruz -->
          ...
          <!-- Banka Durumu seçim alanı -->
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Banka Durum<span class="required">*</span>  <!-- Durum etiketi -->
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">  <!-- Form alanının genişliğini ayarlıyoruz -->
              <select id="heard" class="form-control" name="banka_durum" required>  <!-- Durum için bir dropdown (seçim) alanı oluşturuyoruz -->

                <!-- Banka durumu aktif mi değil mi kontrolünü sağlıyoruz -->
                <option value="1" <?php echo $bankacek['banka_durum'] == '1' ? 'selected=""' : ''; ?>>Aktif</option>  <!-- Eğer banka aktifse seçili hale getiriyoruz -->
                <option value="0" <?php if ($bankacek['banka_durum']==0) { echo 'selected=""'; } ?>>Pasif</option>  <!-- Eğer banka pasifse seçili hale getiriyoruz -->

              </select>
            </div>
          </div>

          <!-- Gizli input alanı (banka ID) -->
          <input type="hidden" name="banka_id" value="<?php echo $bankacek['banka_id'] ?>">  <!-- Banka ID'sini gizli bir şekilde formda gönderiyoruz -->
          ...
          <div class="form-group">
            <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">  <!-- Butonu sağa hizalıyoruz -->
              <button type="submit" name="bankaduzenle" class="btn btn-success">Güncelle</button>  <!-- "Güncelle" butonunu ekliyoruz -->
            </div>
          </div>
